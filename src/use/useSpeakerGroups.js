...
export default function useSpeakerGroups() {
  ...
  function spkName(spkId) {
    ...
    switch (spkId) {
      ...
      case 'tm':
        return side + 'Top Middle';
      case 'tr':
        return side + 'Top Rear';
      case 'fh':
        return side + 'Front Height';
      case 'hb':
        return side + 'Rear Height';
      case 's':
        return side + 'Surround';
      case 's1':
        return side + 'Surround 1';
      case 'w':
        return side + 'Wide';
      case 'b':
        return side + 'Back';
      case 'scr':
        return side + 'Screen';
      case 'rs1':
        return side + 'Rear Surround 1';
      case 'rs2':
        return side + 'Rear Surround 2';
      case 'cs':
        return side + 'Center Surround';
    }
  }
